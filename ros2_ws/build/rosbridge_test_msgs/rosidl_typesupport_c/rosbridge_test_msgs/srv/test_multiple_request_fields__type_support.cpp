...
static const _TestMultipleRequestFields_Request_type_support_symbol_names_t _TestMultipleRequestFields_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Request)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestMultipleRequestFields_Request_message_type_support_handle;
}
...
static const _TestMultipleRequestFields_Response_type_support_symbol_names_t _TestMultipleRequestFields_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestMultipleRequestFields_Response)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestMultipleRequestFields_Response_message_type_support_handle;
}
...
static const _TestMultipleRequestFields_type_support_symbol_names_t _TestMultipleRequestFields_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestMultipleRequestFields)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestMultipleRequestFields)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestMultipleRequestFields)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestMultipleRequestFields_service_type_support_handle;
}
