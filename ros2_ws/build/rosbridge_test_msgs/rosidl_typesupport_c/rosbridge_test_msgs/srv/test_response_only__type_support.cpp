...
static const _TestResponseOnly_Request_type_support_symbol_names_t _TestResponseOnly_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestResponseOnly_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestResponseOnly_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestResponseOnly_Request)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestResponseOnly_Request_message_type_support_handle;
}
...
static const _TestResponseOnly_Response_type_support_symbol_names_t _TestResponseOnly_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestResponseOnly_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestResponseOnly_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestResponseOnly_Response)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestResponseOnly_Response_message_type_support_handle;
}
...
static const _TestResponseOnly_type_support_symbol_names_t _TestResponseOnly_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbridge_test_msgs, srv, TestResponseOnly)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestResponseOnly)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rosbridge_test_msgs, srv, TestResponseOnly)() {
  return &::rosbridge_test_msgs::srv::rosidl_typesupport_c::TestResponseOnly_service_type_support_handle;
}
