...
static const _TestUInt8FixedSizeArray16_type_support_symbol_names_t _TestUInt8FixedSizeArray16_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbridge_test_msgs, msg, TestUInt8FixedSizeArray16)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbridge_test_msgs, msg, TestUInt8FixedSizeArray16)),
  }
};
...
{
  return &::rosbridge_test_msgs::msg::rosidl_typesupport_cpp::TestUInt8FixedSizeArray16_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, msg, TestUInt8FixedSizeArray16)() {
  return get_message_type_support_handle<rosbridge_test_msgs::msg::TestUInt8FixedSizeArray16>();
}
