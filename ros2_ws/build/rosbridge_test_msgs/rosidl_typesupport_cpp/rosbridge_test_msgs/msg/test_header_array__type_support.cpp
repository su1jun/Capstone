...
static const _TestHeaderArray_type_support_symbol_names_t _TestHeaderArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbridge_test_msgs, msg, TestHeaderArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbridge_test_msgs, msg, TestHeaderArray)),
  }
};
...
{
  return &::rosbridge_test_msgs::msg::rosidl_typesupport_cpp::TestHeaderArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbridge_test_msgs, msg, TestHeaderArray)() {
  return get_message_type_support_handle<rosbridge_test_msgs::msg::TestHeaderArray>();
}
