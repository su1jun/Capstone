...
// class GPSControlScreen extends StatefulWidget {
//   final BluetoothDevice device;

//   const GPSControlScreen({Key? key, required this.device}) : super(key: key);

//   @override
//   State<GPSControlScreen> createState() => _GPSControlScreen();
// }

// class _GPSControlScreen extends State<GPSControlScreen> {
...
//       } catch (e) {
//         Snackbar.show(ABC.e, prettyException("Discover Services Error:", e), success: false);
//       }
...
class GeolocatorWidget extends StatefulWidget {
  ...
  const GeolocatorWidget({Key? key, required this.device}) : super(key: key);
